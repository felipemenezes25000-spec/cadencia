...
export function TopBar() {
  ...
  return (
    <>
      <header className="cadencia-topbar sticky top-0 z-20 flex h-[72px] shrink-0 items-center gap-4 border-b border-line px-4 pt-[env(safe-area-inset-top)] md:px-6 xl:px-8">
        <button
          type="button"
