...
export function CaixaDeConversas(p: CaixaDeConversasProps) {
  ...
  return (
    <div className="cadencia-page grid gap-5 max-w-5xl">
      ...
      >
        {FILTROS.map((f) => (
          <button
            ...
            className={cn(
              'min-h-8 cursor-pointer rounded-lg border border-line px-3 py-1 text-xs font-semibold',
      ...
      <ul
        ...
        className="m-0 list-none overflow-hidden rounded-xl border border-line bg-surface p-0 shadow-elev-1"
      >
        {conversas.map((c) => {
          ...
          return (
            ...
            >
              ...
              <div className="relative shrink-0">
                <span
                  aria-hidden="true"
                  className="flex h-10 w-10 items-center justify-center rounded-xl bg-accent-soft text-[13px] font-semibold text-accent"
                >
