...
function GradeDeHorarios({
  ...
  return (
    <div
      ...
      className="overflow-y-auto overflow-x-auto border border-line rounded-[var(--r-md)] bg-surface"
...
function ListaDeAgendamentos({
  ...
  return (
    <div className="divide-y divide-line rounded-[var(--r-md)] border border-line bg-surface">
      {ordenados.map((it) => (
        <div
          key={it.appointmentId}
...
function GradeMes({
  ...
  return (
    <div
      className="border border-line rounded-[var(--r-md)] overflow-hidden bg-surface"
      role="grid"
