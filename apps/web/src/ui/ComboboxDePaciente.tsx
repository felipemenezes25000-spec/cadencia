    ...
    <Popover.Root open={aberto} onOpenChange={setAberto}>
      <div className={cn('relative', className)}>
        ...
        <Popover.Anchor asChild>
          <div
            className={cn(
              'flex items-center gap-2 rounded-[var(--r-md)] border px-3',
          ...
          >
            ...
            <input
              ...
              disabled={disabled}
              className="flex-1 bg-transparent py-2 text-[length:var(--fs-14)] text-text outline-none placeholder:text-text-faint disabled:cursor-not-allowed"
            />
            {carregando && (
              <Icone
                icon={SpinnerGap}
        ...
        <Popover.Content
          ...
          className={cn(
            ...
            'overflow-hidden rounded-[var(--r-md)] border border-line bg-surface shadow-elev-2',
          )}
          sideOffset={4}
        >
          <ul
