    ...
    <AnimatePresence>
      {!online ? (
        ...
        <motion.div
          ...
          initial={{ y: -18, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: -14, opacity: 0 }}
          className="fixed left-1/2 top-3 z-[120] flex -translate-x-1/2 items-center gap-2 rounded-full border border-ok/20 bg-ok-soft px-4 py-2 text-xs font-semibold text-ok shadow-elev-2"
