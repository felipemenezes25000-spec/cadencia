-- 0064_finalize_system_actor.sql
-- Forward-only: nao existe down migration. Para desfazer, escreva a proxima.
-- Este arquivo roda dentro de UMA transacao. Nada de CREATE INDEX CONCURRENTLY.
--
-- §4.4 — o worker de auto-finalizacao roda como ator `system`, que nao tem
-- professional_id derivavel. O coalesce usa o profissional do proprio
-- atendimento quando current_professional_id() retorna NULL e o ator e system.
