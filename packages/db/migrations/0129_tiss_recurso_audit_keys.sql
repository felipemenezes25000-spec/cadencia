-- 0129_tiss_recurso_audit_keys.sql
-- Forward-only: nao existe down migration. Para desfazer, escreva a proxima.
-- Este arquivo roda dentro de UMA transacao. Nada de CREATE INDEX CONCURRENTLY.
--
-- Adiciona chaves de auditoria para envio e resolucao de recurso de glosa TISS:
-- item_count, total_recursado_cents, total_resultados, deferidos.
