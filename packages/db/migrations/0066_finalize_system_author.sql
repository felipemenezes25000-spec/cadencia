-- 0066_finalize_system_author.sql
-- Forward-only: nao existe down migration. Para desfazer, escreva a proxima.
-- Este arquivo roda dentro de UMA transacao. Nada de CREATE INDEX CONCURRENTLY.
--
-- §4.4 complemento — a 0064 corrigiu o professional_id para ator system mas
-- esqueceu o author_user_id, que tambem e NOT NULL em encounter_version.
-- Para o worker, derivamos o usuario do profissional do atendimento (mesma
-- logica de v_prof).
